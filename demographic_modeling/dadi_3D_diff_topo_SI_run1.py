...
def SI(params, ns, pts):
	...
	nuA: Ancestral Ne of balsam and interior tricho
	T1:   Time for divergence between balsam and tricho species with no gene flow
	T2: Time interval with gene flow and divergence of balsam and interior
	...
	phi = dadi.Integration.two_pops(phi,xx,T1,nu1=nuC, nu2=nuA, m12=0, m21=0)
	phi = dadi.PhiManip.phi_2D_to_3D_split_2(xx,phi)
	phi = dadi.Integration.three_pops(phi,xx,T2,nu1=nuC, nu2=nuB, nu3=nuI,m12=0, m21=0,m23=0, m32=0, m13=0, m31=0)
...
matplotlib.pyplot.savefig("SI_3D_diff_topo_unfolded_run1.pdf")
